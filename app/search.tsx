  ...
  return (
    <View className="flex-1 bg-white pt-14 px-5">
      <View className="flex-row items-center gap-3 mb-5">
        ...
        <View className="flex-1 flex-row items-center bg-bg rounded-2xl px-4 py-3">
      ...
      {activeCount() > 0 && (
        <Pressable onPress={() => router.push("/filter")} className="mb-3">
          <Text className="text-primary text-sm">{activeCount()} filter(s) applied</Text>
        </Pressable>
      )}
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text className="text-muted text-center mt-10">No products found.</Text>}
